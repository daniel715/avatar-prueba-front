...
export default function MovieCard({ image, name, characters }) {
    return (
        <>
            <div className="group" style={{width: "30%", marginTop: "50px"}}>
                <div className="relative grid w-full h-[100vw] sm:h-96 md:h-[40vw] flex flex-row items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center">
                    <div
